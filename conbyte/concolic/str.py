...
class ConcolicStr(str, Concolic, metaclass=MetaFinal):
    ...
    def lower(self, /): # <method 'lower' of 'str' objects>
        ...
        value = super().lower()
        expr = ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", ["str.replaceall", self, "A", "a"], "B", "b"], "C", "c"], "D", "d"], "E", "e"], "F", "f"], "G", "g"], "H", "h"], "I", "i"], "J", "j"], "K", "k"], "L", "l"], "M", "m"], "N", "n"], "O", "o"], "P", "p"], "Q", "q"], "R", "r"], "S", "s"], "T", "t"], "U", "u"], "V", "v"], "W", "w"], "X", "x"], "Y", "y"], "Z", "z"]
        # Note that the above expr can be generated by the following code snippet.
        # def f(x):
        #     if x == 96:
        #         return 'self'
        #     return f'["str.replaceall", {f(x-1)}, "{chr(x-32)}", "{chr(x)}"]'
        # print(f(122))
        return ConcolicObject(value, expr)
    ...
    def upper(self, /): # <method 'upper' of 'str' objects>
        ...
        #     if x == 96:
        #         return 'self'
        #     return f'["str.replaceall", {f(x-1)}, "{chr(x)}", "{chr(x-32)}"]'
        # print(f(122))
        return ConcolicObject(value, expr)
