...
def extract_function_list_from_modpath(rootdir, modpath):
    ...
    try:
        mod = func_timeout.func_timeout(10, my_import_module, args=(modpath,))
        print(mod, end='')
        ...
        while i < len(ans):
            ...
            if get_funcobj_from_modpath_and_funcname(rootdir, modpath, ans[i]) is None: del ans[i]; continue # assert 的效果
